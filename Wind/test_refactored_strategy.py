...
from indicators import EMAIndicator, RSIIndicator, VWAPIndicator, MACDIndicator
...
def test_individual_indicators():
    ...
    # Test MACD
    macd_indicator = MACDIndicator(short_window=3, long_window=5, signal_window=2)
    macd_value = macd_indicator.calculate(test_data)
    print(f"MACD values: {macd_value}")
